...
namespace AssetPackage
{
    ...
    public class TrackerAssetSettings : BaseSettings
    {
        ...
        public TrackerAssetSettings()
        {
            ...
            Secure = false;
            BatchSize = 2;
            var timestamp = Math.Round(DateTime.Now.ToUniversalTime()
                .Subtract(new DateTime(1970, 1, 1, 0, 0, 0, DateTimeKind.Utc)).TotalMilliseconds).ToString();
        ...
        /// </value>
        public TrackerAsset.StorageTypes StorageType { get; set; }
        ...
        /// </value>
        public bool BackupStorage { get; set; }
        ...
        ///     The trace format.
        /// </value>
        public TrackerAsset.TraceFormats TraceFormat { get; set; }
