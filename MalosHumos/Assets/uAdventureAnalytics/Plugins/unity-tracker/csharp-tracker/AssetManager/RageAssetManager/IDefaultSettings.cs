...
namespace AssetPackage
{
    ...
    ///     <list type="bullet">
    ///         <item>
    ///             Check if an asset has default
    ///             (application) settings that override build-in default settings.
    ///         </item>
    ///         <item>Load these settings from the game environment.</item>
    ///         <item>
    ///             In certain environments write the actual settings as application defaults. This could
    ///             for instance be Unity in editor mode.
    ///         </item>
    ///     </list>
    /// </summary>
    /// <remarks>
    ///     <para>
    ///         Default settings and application default settings are read-only at run-
    ///         time.
    ///     </para>
    ///     <para>
    ///         If modification and storage is needed at run-time,
    ///         the<see cref="IDataStorage" />interface could be used
    ///         i.c.m.<see cref="ISettings" />Methods.
    ///     </para>
    ///     <para>
    ///         This interface, if implemented in a bridge, allows to check if an <see cref="BaseAsset" />
    ...
    public interface IDefaultSettings
    {
        ...
        /// </returns>
        bool HasDefaultSettings(string Class, string Id);
